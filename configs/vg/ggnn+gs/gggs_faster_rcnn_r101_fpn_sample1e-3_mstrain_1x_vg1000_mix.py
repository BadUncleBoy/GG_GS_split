...
model = dict(
    ...
    backbone=dict(frozen_stages=1,depth=101),
    roi_head=dict(
...
data = dict(samples_per_gpu=4, workers_per_gpu=4, train=dict(dataset=dict(pipeline=train_pipeline)))
work_dir = "exps/vg/gggsr101_mix_new"
seed = 0
gpu_ids = range(0, 1)
load_from = "exps/vg/r101/epoch_12.pth"
resume_from=None
